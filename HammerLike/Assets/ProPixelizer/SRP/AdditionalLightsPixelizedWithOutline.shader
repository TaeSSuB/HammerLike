...
Shader "ProPixelizer/SRP/AdditionalLightsPixelizedWithOutline"
{
    ...
    Properties
    {
		...
		SubShader
		{
			...
			UsePass "ProPixelizer/Hidden/AdditionalLightsProPixelizerBase/UNIVERSAL FORWARD"
			UsePass "ProPixelizer/Hidden/AdditionalLightsProPixelizerBase/SHADOWCASTER"
			UsePass "ProPixelizer/Hidden/AdditionalLightsProPixelizerBase/DEPTHONLY"
			UsePass "ProPixelizer/Hidden/AdditionalLightsProPixelizerBase/DEPTHNORMALS"
