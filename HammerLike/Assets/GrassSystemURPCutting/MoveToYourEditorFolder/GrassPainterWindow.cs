...
public class GrassPainterWindow : EditorWindow
{
    ...
    private struct MyJob : IJob
    {
        ...
        public void Execute()
        {
            ...
            // 레드 체크 
            if (VertexColorSettings.HasFlag(SO_GrassToolSettings.VertexColorSetting.Red) && MeshColors[MeshTriangles[triIndex * 3]].r > 0.5f)
            {
                block = true;
            }

            // 그린 체크
            if (VertexColorSettings.HasFlag(SO_GrassToolSettings.VertexColorSetting.Green) && MeshColors[MeshTriangles[triIndex * 3]].g > 0.5f)
            {
                block = true;
            }

            // 블루 체크 
            if (VertexColorSettings.HasFlag(SO_GrassToolSettings.VertexColorSetting.Blue) && MeshColors[MeshTriangles[triIndex * 3]].b > 0.5f)
            {
                block = true;
            }

            if (VertexColorSettings.HasFlag(SO_GrassToolSettings.VertexColorSetting.Alpha) && MeshColors[MeshTriangles[triIndex * 3]].a > 0.5f)
            {
                block = true;
            }
            ...
            // Red Fade
            if (VertexFade.HasFlag(SO_GrassToolSettings.VertexColorSetting.Red))
            {
            ...
            // Green Fade
            if (VertexFade.HasFlag(SO_GrassToolSettings.VertexColorSetting.Green))
            {
            ...
            // Blue Fade
            if (VertexFade.HasFlag(SO_GrassToolSettings.VertexColorSetting.Blue))
            {
            ...
            if (VertexFade.HasFlag(SO_GrassToolSettings.VertexColorSetting.Alpha))
            {
