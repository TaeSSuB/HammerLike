...
#pragma warning restore 0618
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            ExecutePass(
                ...
                Materials.CopyDepth,
                usePixelExpansion,
                PixelatedColorTarget(ref renderingData, TargetPass),
                PixelatedDepthTarget(ref renderingData, TargetPass),
                _OriginalScene,
                _PixelatedScene,
        ...
        public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
        {
            ...
            var pfColorTarget = UniversalRenderer.CreateRenderGraphTexture(
                renderGraph, colorDescriptor, "ProPixelizer_PointFilteredColorTarget", true, FilterMode.Point, TextureWrapMode.Clamp);
            var pixelatedScene = UniversalRenderer.CreateRenderGraphTexture(
                renderGraph, colorDescriptor, "ProPixelizer_PixelatedScene", true, FilterMode.Point, TextureWrapMode.Clamp);
            var pixelatedSceneDepth = UniversalRenderer.CreateRenderGraphTexture(
                renderGraph, depthDescriptor, "ProPixelizer_PixelatedSceneDepth", true, FilterMode.Point, TextureWrapMode.Clamp);
            ...
            using (var builder = renderGraph.AddUnsafePass<PassData>(GetType().Name, out var passData))
            {
                ...
                passData.ColorTargetDepth = lowResTarget.Depth;
