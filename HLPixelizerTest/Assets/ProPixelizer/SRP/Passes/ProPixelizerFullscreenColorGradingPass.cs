...
#pragma warning restore 0618
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            if (renderingData.cameraData.cameraType == CameraType.Preview)
                return; // for some reason configure isn't running for preview cameras?
        ...
        public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
        {
            ...
            var tempColor = UniversalRenderer.CreateRenderGraphTexture(
                renderGraph, descriptor, ProPixelizerTargets.PROPIXELIZER_FULLSCREEN_COLOR_GRADING, false);
