...
#pragma warning disable 0618
            RenderingUtils.ReAllocateIfNeeded(ref MetadataObjectBuffer, outlineDescriptor, name: ProPixelizerTargets.PROPIXELIZER_METADATA_BUFFER, wrapMode: TextureWrapMode.Clamp);
...
#pragma warning restore 0618
        ...
        public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
        {
            ...
            metadataTarget.Color = UniversalRenderer.CreateRenderGraphTexture(renderGraph, colorDescriptor, name: ProPixelizerTargets.PROPIXELIZER_METADATA_BUFFER, false, wrapMode: TextureWrapMode.Clamp);
            metadataTarget.Depth = UniversalRenderer.CreateRenderGraphTexture(renderGraph, depthDescriptor, name: ProPixelizerTargets.PROPIXELIZER_METADATA_BUFFER_DEPTH, false, wrapMode: TextureWrapMode.Clamp);
