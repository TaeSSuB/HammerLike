...
public class CorridorFirstDungeonGenerator : SimpleRndWalkDungeonGenerator
{
    [SerializeField]
    ...
    private void CreateCorridors(HashSet<Vector2Int> floorPositions, HashSet<Vector2Int> potentialRoomPositions)
    {
        ...
        {
            var corridor = ProceduraGenerationAlgorithms.RandomWalkCorridor(currentPosition, corridorLength);
